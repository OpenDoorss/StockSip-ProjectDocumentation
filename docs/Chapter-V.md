...
| User Stories |                                         | Work Item/Task |                                                                                    |                                                                                                                                                      |                    |                |        |
| Id           | Title                                   | Id             | Title                                                                              | Description                                                                                                                                          | Estimation (Hours) | Assigned to    | Status |
| US059        | Generar orden de compra                 | US059T001      | Crear un boton para agregar una nueva orden de compra                              | Crear una sección que muestre los beneficios que ofrece la aplicación a los usuarios.                                                                | 4                  | Camila Huamani | Done   |
|              |                                         | US059T002      | Crear un boton para generar una orden de compra automaticamente                    | Crear una sección que muestre los planes que ofrece la aplicación a los usuarios.                                                                    | 4                  | Camila Huamani | Done   |
|              |                                         | US059T003      | Implementar un snackbar para las notificaciones en la seccion de ordenes de compra | Crear una sección que muestre información sobre la startup detrás de la aplicación.                                                                  | 4                  | Camila Huamani | Done   |
|              |                                         | US059T004      | Crear un formulario para la creación de una nueva orden                            | Crear un formulario para la creación de una nueva orden.                                                                                             | 4                  | Camila Huamani | Done   |
| US060        | Visualizar estado de la orden de compra | US060T001      | Crear un formulario para la creación de una nueva orden                            | Crear un formulario para la creación de una nueva orden.                                                                                             | 4                  | Camila Huamani | Done   |
|              |                                         | US060T002      | Crear una sección de preguntas frecuentes de la aplicación                         | Crear una sección que muestre preguntas frecuentes sobre la aplicación.                                                                              | 4                  | Camila Huamani | Done   |
| US003        | Landing Page                            | US060T003      | Crear una sección de testimonios de la aplicación                                  | Crear una sección que muestre testimonios de usuarios sobre la aplicación.                                                                           | 4                  | Camila Huamani | Done   |
| US004        | Landing Page                            | US060T001      | Crear una sección de noticias de la aplicación                                     | Crear una sección que muestre noticias relacionadas con la aplicación.                                                                               | 4                  | Camila Huamani | Done   |
| US005        | Landing Page                            | US005T001      | Crear una sección de imágenes de la aplicación                                     | Crear una sección que muestre imágenes de la aplicación.                                                                                             | 4                  | Camila Huamani | Done   |
|              |                                         | US005T002      | Añadir imágenes a la sección sobre la aplicación                                   | En la sección sobre la aplicación del Landing Page, agregar imágenes de las principales secciones de la aplicación.                                  | 4                  | Camila Huamani | Done   |
|              |                                         | US005T003      | Dar estilo a la sección sobre la aplicación                                        | Usar CSS para darle una mejor vista a la sección sobre la aplicación.                                                                                | 4                  | Camila Huamani | Done   |
|              |                                         | US005T004      | Agregar un botón para cambiar de idiomas en el Landing Page                        | En el header del Landing Page, agregar un botón que sea programado para que cambie el idioma de la página.                                           | 5.5                | Camila Huamani | Done   |
| US006        | Landing Page                            | US006T001      | Crear una sección de Call-To-Action para el Landing Page                           | Crear una sección que invite a los visitantes a registrarse en la aplicación.                                                                        | 4                  | Camila Huamani | Done   |
| US007        | Landing Page                            | US007T001      | Crear una sección de información sobre el equipo detrás de la aplicación           | Crear una sección que muestre información sobre el equipo detrás de la aplicación.                                                                   | 4                  | Camila Huamani | Done   |
| US008        | Landing Page                            | US008T001      | Crear una sección de video introductorio sobre la aplicación                       | Crear una sección que muestre un video introductorio sobre la aplicación.                                                                            | 4                  | Camila Huamani | Done   |
| US009        | Landing Page                            | US009T001      | Crear una sección de registro de usuario                                           | Crear un componente para registro de usuarios usando espacios para completar como nombre, correo, contraseña y dirección.                            | 4                  | Camila Huamani | Done   |
|              |                                         | US009T002      | Añadir estilos a la sección de registro de usuario                                 | Usar estilos con CSS para darle mejor vista a la pantalla de registro.                                                                               | 4                  | Camila Huamani | Done   |
|              |                                         | US009T003      | Integrar un API para selección de dirección del usuario                            | Para el apartado de la dirección de usuario se debe usar un API que muestre un mapa con el que el usuario puede interactuar para marcar su ubicación | 4.5                | Camila huamani | Done   |
| US010        | Landing Page                            | US010T001      | Crear un botón para seleccionar rol de usuario                                     | Usando Angular Material, usar el componente del botón "select" para que el usuario pueda elegir su rol al registrarse.                               | 4                  | Camila Huamani | Done   |
| US011        | Landing Page                            | US011T001      | Crear una sección para inicio de sesión de usuarios                                | Crear un componente para inicio de sesión de usuarios usando como requisitos el usuario y la contraseña.                                             | 4                  | Camila Huamani | Done   |
|              |                                         | US011T002      | Añadir estilos a la sección de inicio de sesión de usuario                         | Usar estilos con CSS para darle mejor vista a la pantalla de inicio de sesión.                                                                       | 4                  | Camila Huamani | Done   |
| US012        | Landing Page                            | US012T001      | Crear una sección de contacto de la aplicación                                     | Crear un componente que permita a los usuarios enviar mensajes al equipo de soporte de la aplicación.                                                | 4                  | Camila Huamani | Done   |
| US013        | Landing Page                            | US013T001      | Crear una sección de información sobre la aplicación                               | Crear un componente que muestre información sobre la aplicación.                                                                                     | 4                  | Camila Huamani | Done   |
| US014        | Landing Page                            | US014T001      | Crear una sección de información sobre la empresa                                  | Crear un componente que muestre información sobre la empresa detrás de la aplicación.                                                                | 4                  | Camila Huamani | Done   |
| US015        | Landing Page                            | US015T001      | Crear una sección de información sobre la industria                                | Crear un componente que muestre información sobre la industria en la que opera la aplicación.                                                        | 4                  | Camila Huamani | Done   |
| US016        | Landing Page                            | US016T001      | Crear una sección de información sobre la competencia                              | Crear un componente que muestre información sobre la competencia de la aplicación.                                                                   | 4                  | Camila Huamani | Done   |
| US017        | Landing Page                            | US017T001      | Crear una sección de información sobre la comunidad                                | Crear un componente que muestre información sobre la comunidad de usuarios de la aplicación.                                                         | 4                  | Camila Huamani | Done   |
| US018        | Landing Page                            | US018T001      | Crear una sección de información sobre la seguridad de la aplicación               | Crear un componente que muestre información sobre la seguridad de la aplicación.                                                                     | 4                  | Camila Huamani | Done   |
| US019        | Landing Page                            | US019T001      | Crear una sección de información sobre la privacidad de la aplicación              | Crear un componente que muestre información sobre la privacidad de la aplicación.                                                                    | 4                  | Camila Huamani | Done   |
| US020        | Landing Page                            | US020T001      | Crear una sección de información sobre la accesibilidad de la aplicación           | Crear un componente que muestre información sobre la accesibilidad de la aplicación.                                                                 | 4                  | Camila Huamani | Done   |
| US021        | Landing Page                            | US021T001      | Crear una sección de información sobre la sostenibilidad de la aplicación          | Crear un componente que muestre información sobre la sostenibilidad de la aplicación.                                                                | 4                  | Camila Huamani | Done   |
| US022        | Landing Page                            | US022T001      | Crear una sección de información sobre la escalabilidad de la aplicación           | Crear un componente que muestre información sobre la escalabilidad de la aplicación.                                                                 | 4                  | Camila Huamani | Done   |
| US023        | Landing Page                            | US023T001      | Crear una sección de información sobre la personalización de la aplicación         | Crear un componente que muestre información sobre la personalización de la aplicación.                                                               | 4                  | Camila Huamani | Done   |
| US024        | Landing Page                            | US024T001      | Crear una sección de información sobre la integración de la aplicación             | Crear un componente que muestre información sobre la integración de la aplicación con otras herramientas.                                            | 4                  | Camila Huamani | Done   |
| US025        | Landing Page                            | US025T001      | Crear una sección de información sobre la compatibilidad de la aplicación          | Crear un componente que muestre información sobre la compatibilidad de la aplicación con diferentes sistemas operativos y navegadores.               | 4                  | Camila Huamani | Done   |
| US001        | Landing Page                            | US001T001      | Crear un boton para agregar una nueva orden de compra                              | Crear una sección que muestre los beneficios que ofrece la aplicación a los usuarios.                                                                | 4                  | Camila Huamani | Done   |
|              |                                         | US001T002      | Crear un boton para generar una orden de compra automaticamente                    | Crear una sección que muestre los planes que ofrece la aplicación a los usuarios.                                                                    | 4                  | Camila Huamani | Done   |
|              |                                         | US001T003      | Implementar un snackbar para las notificaciones en la seccion de ordenes de compra | Crear una sección que muestre información sobre la startup detrás de la aplicación.                                                                  | 4                  | Camila Huamani | Done   |
| US002        | Landing Page                            | US002T001      | Crear un                                                                           | Crear una sección que muestre información de contacto de la aplicación.                                                                              | 4                  | Camila Huamani | Done   |
|              |                                         | US002T002      | Crear una sección de preguntas frecuentes de la aplicación                         | Crear una sección que muestre preguntas frecuentes sobre la aplicación.                                                                              | 4                  | Camila Huamani | Done   |
| US003        | Landing Page                            | US003T001      | Crear una sección de testimonios de la aplicación                                  | Crear una sección que muestre testimonios de usuarios sobre la aplicación.                                                                           | 4                  | Camila Huamani | Done   |
| US004        | Landing Page                            | US004T001      | Crear una sección de noticias de la aplicación                                     | Crear una sección que muestre noticias relacionadas con la aplicación.                                                                               | 4                  | Camila Huamani | Done   |
| US005        | Landing Page                            | US005T001      | Crear una sección de imágenes de la aplicación                                     | Crear una sección que muestre imágenes de la aplicación.                                                                                             | 4                  | Camila Huamani | Done   |
|              |                                         | US005T002      | Añadir imágenes a la sección sobre la aplicación                                   | En la sección sobre la aplicación del Landing Page, agregar imágenes de las principales secciones de la aplicación.                                  | 4                  | Camila Huamani | Done   |
|              |                                         | US005T003      | Dar estilo a la sección sobre la aplicación                                        | Usar CSS para darle una mejor vista a la sección sobre la aplicación.                                                                                | 4                  | Camila Huamani | Done   |
|              |                                         | US005T004      | Agregar un botón para cambiar de idiomas en el Landing Page                        | En el header del Landing Page, agregar un botón que sea programado para que cambie el idioma de la página.                                           | 5.5                | Camila Huamani | Done   |
